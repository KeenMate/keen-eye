<template>
	<div class="form-horizontal">
		<div class="d-inline-block">
			<multiselect class="multiselect-sm overflow" @keyup.esc.stop v-model="seletedLocale" :options="langs"
				:multiple="false" track-by="code" label="name" placeholder="Select language" :show-labels="false"
				group-values="languages" group-label="type" :custom-label="customLabel" @remove="(val) => changeLocale(val)"
				@select="(val) => changeLocale(val)"></multiselect>
		</div>
